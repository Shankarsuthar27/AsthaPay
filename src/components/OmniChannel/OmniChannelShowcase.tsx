...
import { Monitor, Smartphone, CreditCard, Settings } from 'lucide-react';
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {platformCards.map((card, idx) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="bg-[#1c4d92]/40 hover:bg-[#1c4d92]/60 border border-blue-400/25 hover:border-blue-400/50 rounded-t-[28px] sm:rounded-t-[36px] p-5 sm:p-6 pb-16 sm:pb-32 backdrop-blur-md shadow-xl transition-colors duration-300 flex flex-col group cursor-default"
              >
                {/* Card Icon */}
        ...
        <motion.div
          ...
          className="-mt-10 sm:-mt-24 md:-mt-28 relative z-20"
        >
