      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 text-center lg:text-left">
            {/* Pill Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/90 border border-slate-200 shadow-soft-sm text-[11px] font-bold text-brand-navy">
            ...
            {/* Bold Headline */}
            <h1 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-black text-brand-navy tracking-tight leading-[1.12]">
              Power Your FinTech With{' '}
              <span className="gradient-text-coral">Turnkey Banking</span> APIs
            </h1>

            {/* Subtitle */}
            <p className="text-sm sm:text-[15px] text-slate-600 max-w-xl mx-auto lg:mx-0 leading-relaxed font-normal">
              Launch AePS, Micro-ATM, DMT & BBPS in 24 hours under your own brand.
            </p>

            {/* Feature Checkpoints */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 pt-0.5 text-[11.5px] font-semibold text-slate-700">
              <span className="inline-flex items-center gap-1.5 bg-white/90 px-2.5 py-1 rounded-full border border-slate-200/70 shadow-2xs">
            ...
            {/* Small reassurance */}
            <div className="flex items-center justify-center lg:justify-start gap-2.5 text-[11px] text-slate-500 pt-0.5">
