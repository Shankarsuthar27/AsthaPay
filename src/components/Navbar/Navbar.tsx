...
export const Navbar: React.FC<NavbarProps> = ({ onOpenDemoModal }) => {
  ...
  return (
    <>
      ...
      <div className="bg-brand-navy text-white text-[11px] py-1.5 px-4 hidden md:block border-b border-slate-800">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-5 text-slate-300">
            <a href="tel:+918001234567" className="flex items-center gap-1.5 hover:text-brand-coral transition-colors">
              ...
              <span>Enterprise Helpline: 1800-123-4567</span>
            </a>
      ...
      <header
        className={`sticky top-0 z-50 transition-all duration-300 ${
          isScrolled
            ? 'glass-nav shadow-soft-md border-b border-slate-200/80 py-3'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-1 xl:gap-2">
              ...
              <a
                href="#pricing"
                className="px-3.5 py-2 rounded-xl text-sm font-semibold text-slate-700 hover:text-brand-navy hover:bg-slate-100/70 transition-all"
              >
                Pricing
              </a>
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a
                href="#portal"
                className="text-xs font-bold text-brand-navy hover:text-brand-coral px-3 py-2 transition-colors flex items-center gap-1"
              >
                Login
              </a>
              ...
              <button
                ...
                className="relative group overflow-hidden rounded-full bg-gradient-to-r from-brand-coral via-[#FF6247] to-brand-coral-hover text-white text-sm font-bold px-6 py-2.5 shadow-coral-glow hover:shadow-lg transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] flex items-center gap-2"
              >
            ...
            <div className="flex items-center gap-2 lg:hidden">
              <button
                onClick={onOpenDemoModal}
                className="bg-brand-coral text-white text-xs font-bold px-3.5 py-2 rounded-full shadow-sm"
              >
                Demo
              </button>
              <button
