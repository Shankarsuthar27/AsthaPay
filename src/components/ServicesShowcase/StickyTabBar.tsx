          ...
          {serviceCategoriesData.map((category) => {
            ...
            return (
              <button
                ...
                className={`relative px-4 sm:px-5 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-bold transition-all duration-200 whitespace-nowrap flex items-center gap-2 shrink-0 select-none ${
                  isActive
                    ? 'text-white'
